        ...
        <div class="container">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title">Add Vehicle Issue</h1>
                                    <nav>
                            ...
                            <div class="nk-block-head-content">
                                <ul class="d-flex">
                                    ...
                                    <li><a href="{{ route('vehicle.issues.index') }}" class="btn btn-primary d-none d-md-inline-flex"><em
                    ...
                    <div class="nk-block">
                        <form action="{{ route('vehicle.issues.store') }}" method="POST">
                            @csrf
                            <div class="row g-gs">
                                <div class="col-xxl-9">
                                    <div class="gap gy-4">
