                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title">Add New Fuel</h1>
                                    <nav>
                            ...
                            <div class="nk-block-head-content">
                                <ul class="d-flex">
                                    ...
                                    <li><a href="{{ route('fuels.index') }}" class="btn btn-primary d-none d-md-inline-flex"><em
                                                class="icon ni ni-eye"></em><span>View Fuels</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                                    ...
                                                    <div class="row g-gs">
                                                        <div class="col-lg-6">
                                                            <div class="form-group"><label for="productname"
                                                                    class="form-label">Fuel Name</label>
                                                      ...
                                                      <div class="col-lg-6">
                                                            <div class="form-group"><label for="productname"
                                                                    class="form-label">Fuel Price</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" name="price"
                                                                        class="form-control" placeholder="Fuel Price">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
