                            ...
                            <div class="nk-nav-mega nk-nav-mega-lg">
                                <div class="nk-nav-col">
                                    ...
                                    <ul class="link-list link-list-md link-list-hover-bg-primary">
                                        ...
                                        <li><a href="components/button-group.html">Button group</a>
                                        </li>
                                        <li><a href="components/card.html">Cards</a></li>
                                        <li><a href="components/close-button.html">Close button</a>
                                        </li>
                                        <li><a href="components/list-group.html">List group</a></li>
                                        <li><a href="components/pagination.html">Pagination</a></li>
                                        <li><a href="components/placeholders.html">Placeholders</a>
                                        </li>
                                ...
                                <div class="nk-nav-col nk-nav-media"><img src="images/thumb/a.jpg" alt=""
                                        class="rounded-3"></div>
                            </div>
                        </div>
                    </li>
