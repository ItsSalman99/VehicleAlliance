                ...
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item"><a href="{{ route('services.index') }}" class="nk-menu-link"><span
                                        class="nk-menu-text">All Services</span></a></li>
                            <li class="nk-menu-item"><a href="{{ route('services.create') }}" class="nk-menu-link"><span
                                        class="nk-menu-text">Add Service</span></a></li>
                        </ul>
                    </li>
                    <li class="nk-menu-heading">
                    ...
                    <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item"><a href="{{ route('vehicle.index') }}" class="nk-menu-link"><span
                                        class="nk-menu-text">All Vehicle</span></a></li>
                            <li class="nk-menu-item"><a href="{{ route('vehicle.create') }}" class="nk-menu-link"><span
                                        class="nk-menu-text">Add Vehicle</span></a></li>
                    ...
                    <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item"><a href="apps/kanban/kanban-basic.html" class="nk-menu-link"><span
                                        class="nk-menu-text">Vehicle Parts Estimation</span></a></li>
                        </ul>
                    </li>
                    <li class="nk-menu-heading">
                    ...
                    <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item"><a href="{{ route('slider.create') }}" class="nk-menu-link"><span
                                        class="nk-menu-text">Manage Slider</span></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
